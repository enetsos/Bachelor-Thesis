...
In questo capitolo viene descritto in modo dettagliato l’implementazione dei vari componenti
presenti all’interno del progetto con le relative motivazioni sulle scelte intraprese.
...
\begin{table}[h!]
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|l|l|l|}
      ...
      GET                  & /auth/user-info                                             & Permette di ricavare le informazioni dell'utente autenticato. \\ \hline
